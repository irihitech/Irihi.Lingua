...
using Irihi.Lolita.Avalonia.Tests.ViewModels;
using Irihi.Lolita.Avalonia.Tests.Views;
using Xunit;
...
public class LocalizeExtensionTests
{
    ...
    public void LocalizeView_OnLoad_ShowsDefaultCultureValues()
    {
        ...
        Assert.Equal("Lolita Headless Test", appTitle.Text);
    ...
    public void LocalizeView_AfterSwitchToChinese_BothTextBlocksUpdateToChineseValues()
    {
        ...
        Assert.Equal("Lolita 无头测试", appTitle.Text);
    ...
    {
        var key = new LolitaKey("NoSuchKey", TestLanguageManager.Instance);
